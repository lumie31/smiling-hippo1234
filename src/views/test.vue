      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <div class="formSectionTitle">Business Relationship</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
...
export default {
  data() {
    return {
      category: "Non Compete Contract",
      tagName: "noncompete",
      origParagraphLength: this.$store.state.general.nonCompeteParagraphs
        .length,
  ...
  mounted() {
    this.paragraphList = this.$store.state.general.nonCompeteParagraphs;
    this.clauseList = this.$store.state.general.nonCompeteClauseList;
