      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Owner" background-color="white"></v-textarea>
            </v-col>
            <v-col cols="6">
        ...
        <v-container fluid paraClauseHolder>
          <v-row>
            <v-col cols="12">
              <div class="formSectionTitle">The Lease</div>
              <div
...
export default {
  data() {
    return {
      category: "Equipment Leasing Contract",
      tagName: "equipmentleasing",
      origParagraphLength: this.$store.state.fashionAndBeauty.equipmentLeasingContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.fashionAndBeauty.equipmentLeasingContractParagraphs;
  },
  methods: {
