...
export default {
  data() {
    return {
      ...
      origParagraphLength: this.$store.state.fashionAndBeauty.trainingContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.fashionAndBeauty.trainingContractParagraphs;
  },
  methods: {
