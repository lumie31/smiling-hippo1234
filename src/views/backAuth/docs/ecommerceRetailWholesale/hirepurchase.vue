      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Promoter" background-color="white"></v-textarea>
            </v-col>
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Sponsor" background-color="white"></v-textarea>
            </v-col>
          </v-row>
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
...
export default {
  data() {
    return {
      category: "Hire Purchase Contract",
      tagName: "hirepurchasecontract",
      origParagraphLength: this.$store.state.ecommerceRetailWholesale
        .sponsorshipContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.ecommerceRetailWholesale.sponsorshipContractParagraphs;
  },
  methods: {
