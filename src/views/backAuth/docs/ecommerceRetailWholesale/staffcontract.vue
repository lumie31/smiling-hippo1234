...
export default {
  data() {
    return {
      ...
      origParagraphLength: this.$store.state.ecommerceRetailWholesale.StaffContractParagraphs
        .length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
  ...
  mounted() {
    this.paragraphList = this.$store.state.ecommerceRetailWholesale.StaffContractParagraphs;
  },
  methods: {
