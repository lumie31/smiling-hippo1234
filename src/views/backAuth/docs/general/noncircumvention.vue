    ...
    <div class="bodyWrapper">
      ...
      <v-container fluid class="docParent pb-12">
        ...
        <v-container fluid paraClauseHolder>
          <v-row>
            <v-col cols="12">
              <div class="formSectionTitle">NON CIRCUMVENTION</div>
              <div
...
export default {
  data() {
    return {
      category: "Non-Circumvention Contract",
      tagName: "noncircumvention",
      origParagraphLength: this.$store.state.general.nonCircumventionParagraphs
        .length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
  ...
  mounted() {
    this.paragraphList = this.$store.state.general.nonCircumventionParagraphs;
  },
  methods: {
