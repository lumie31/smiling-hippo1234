...
export default {
  data() {
    return {
      category: "Loan Contract",
      tagName: "loancontract",
      origParagraphLength: this.$store.state.general.loanContractParagraphs
        .length,
      origClauseLength: this.$store.state.general.loanContractClauseList.length,
      paragraphList: [],
      clauseList: [],
      loanType: ["per annum", "per month", "per week", "per day"],
      formOutput: {
        date: "",
        durationNumber: 1
      },
  ...
  mounted() {
    this.paragraphList = this.$store.state.general.loanContractParagraphs;
    this.clauseList = this.$store.state.general.loanContractClauseList;
