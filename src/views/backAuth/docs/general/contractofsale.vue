    ...
    <div class="bodyWrapper">
      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 50%; margin: 0 auto;">
            <v-col cols="12">
              <div class="formSectionTitle">DELIVERY DATE</div>
              <v-menu
                :close-on-content-click="false"
                transition="scale-transition"
                offset-y
        ...
        <v-container fluid paraClauseHolder>
          <v-row>
            <v-col cols="12">
              <div class="formSectionTitle">CONTRACT OF SALE</div>
              <div
...
export default {
  ...
  mounted() {
    this.paragraphList = this.$store.state.general.contractOfSaleParagraphs;
  },
  methods: {
