...
export default {
  data() {
    return {
      ...
      origParagraphLength: this.$store.state.entertainmentAndMedia.StaffContractParagraphs
        .length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
  ...
  mounted() {
    this.paragraphList = this.$store.state.entertainmentAndMedia.StaffContractParagraphs;
  },
  methods: {
