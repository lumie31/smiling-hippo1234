      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Licensor" background-color="white"></v-textarea>
            </v-col>
            <v-col cols="6">
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">Asset</div>
              <v-textarea
                min-height="110"
                outlined
...
export default {
  ...
  mounted() {
    this.paragraphList = this.$store.state.entertainmentAndMedia.licenseContractParagraphs;
  },
  methods: {
