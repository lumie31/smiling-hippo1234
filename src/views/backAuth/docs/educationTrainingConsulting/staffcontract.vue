    ...
    <div class="bodyWrapper">
      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">JOB DESCRIPTION</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
            ...
            <v-col cols="6">
              <div class="formSectionTitle">JOB LOCATION</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">WORK HOURS</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
            ...
            <v-col cols="6">
              <div class="formSectionTitle">ANNUAL LEAVE</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">COMPENSATION</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
            ...
            <v-col cols="6">
              <div class="formSectionTitle">MONTHLY SALARY</div>
              <v-textarea
                min-height="110"
                outlined
                background-color="white"
...
export default {
  data() {
    return {
      ...
      origParagraphLength: this.$store.state.educationTrainingConsulting.StaffContractParagraphs
        .length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
  ...
  mounted() {
    this.paragraphList = this.$store.state.educationTrainingConsulting.StaffContractParagraphs;
  },
  methods: {
