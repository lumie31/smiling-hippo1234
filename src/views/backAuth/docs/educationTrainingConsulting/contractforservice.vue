      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Client" background-color="white"></v-textarea>
            </v-col>
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Service Provider" background-color="white"></v-textarea>
            </v-col>
          </v-row>
...
export default {
  data() {
    return {
      category: "Contract For Service",
      tagName: "contractforservice",
      origParagraphLength: this.$store.state.educationTrainingConsulting
        .contractForServiceParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.educationTrainingConsulting.contractForServiceParagraphs;
  },
  methods: {
