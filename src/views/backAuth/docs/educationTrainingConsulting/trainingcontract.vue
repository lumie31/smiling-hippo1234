      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Trainer" background-color="white"></v-textarea>
            </v-col>
            <v-col cols="6">
              <v-textarea min-height="110" outlined placeholder="Trainee" background-color="white"></v-textarea>
            </v-col>
          </v-row>
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
            ...
            <v-col cols="6">
              <div class="formSectionTitle">Location</div>
              <v-textarea min-height="110" outlined background-color="white"></v-textarea>
            </v-col>
          </v-row>
          <v-row style="width: 50%; margin: 0 auto;">
            <v-col cols="12">
              <div class="formSectionTitle">Working Hours</div>
              <v-textarea min-height="110" outlined background-color="white"></v-textarea>
            </v-col>
          </v-row>
...
export default {
  data() {
    return {
      category: "Training Contract",
      tagName: "trainingcontract",
      origParagraphLength: this.$store.state.educationTrainingConsulting
        .trainingContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.educationTrainingConsulting.trainingContractParagraphs;
  },
  methods: {
