      ...
      <v-container class>
        <v-row>
          <v-col cols="12" sm="12" class="legalbox-wrapper d-flex align-center">
            <img src="@/assets/edu-train-con-icon.png" class="legalbox-icons" width="40" />
            <h2 class="display-1 ml-4">educationTrainingConsulting</h2>
          </v-col>
        </v-row>
        <v-row>
      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            ...
            <v-col cols="6">
              <div class="formSectionTitle">Name of Business</div>
              <v-textarea min-height="110" outlined background-color="white"></v-textarea>
            </v-col>
          </v-row>
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="12">
              <div class="formSectionTitle">Capital Contribution</div>
            </v-col>
            <v-col cols="6">
              <v-textarea
                min-height="110"
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="12">
              <div class="formSectionTitle">Liability of Partners</div>
            </v-col>
            <v-col cols="6">
              <v-textarea
                min-height="110"
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">LOCATION OF DELIVERY</div>
              <v-textarea
                min-height="110"
                placeholder="First Party"
                outlined
            ...
            <v-col cols="6">
              <div class="formSectionTitle">DESCRIPTION OF GOODS</div>
              <v-textarea
                min-height="110"
                placeholder="Second Party"
                outlined
        ...
        <v-container fluid paraClauseHolder>
          <v-row>
            <v-col cols="12">
              <div class="formSectionTitle">Business of Partnership</div>
              <div
...
export default {
  data() {
    return {
      ...
      tagName: "partnershipcontract",
      origParagraphLength: this.$store.state.educationTrainingConsulting
        .partnershipContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.educationTrainingConsulting.partnershipContractParagraphs;
  },
  methods: {
  ...
  computed: {
    fetchOwnBackgroundDetails() {
      let eachDoc = this.$store.state.educationTrainingConsultingHeaders;
