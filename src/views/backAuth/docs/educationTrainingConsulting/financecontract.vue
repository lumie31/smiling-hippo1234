    ...
    <div class="bodyWrapper">
      ...
      <v-container fluid class="docParent pb-12">
        <v-container>
          ...
          <v-row style="width: 80%; margin: 0 auto;">
            <v-col cols="6">
              <div class="formSectionTitle">Investment</div>
              <v-textarea
                min-height="110"
                placeholder="First Party"
                outlined
            ...
            <v-col cols="6">
              <div class="formSectionTitle">Return on Investment</div>
              <v-textarea
                min-height="110"
                placeholder="Second Party"
                outlined
...
export default {
  data() {
    return {
      category: "Financed Contract",
      tagName: "financecontract",
      origParagraphLength: this.$store.state.educationTrainingConsulting
        .financeContractParagraphs.length,
      paragraphList: [],
      clauseList: [],
      formOutput: {
        date: "",
  ...
  mounted() {
    this.paragraphList = this.$store.state.educationTrainingConsulting.financeContractParagraphs;
  },
  methods: {
